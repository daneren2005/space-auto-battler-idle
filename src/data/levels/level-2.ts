...
// bigger and ships tankier than level 1's one-hit skirmishes.  The player holds the bottom edge and the enemy
// the top, both horizontally centred.  The player also brings whatever openShip / shield upgrades they bought in level 1
